...
- A 16 kHz Regression model and its TensorRT engines. Follow the workspace
  instructions for [model acquisition](getting-started.md#explicit-model-acquisition)
  and [engine generation](getting-started.md#tensorrt-engine-generation).
...
See [Logging](logging.md) for the full format, filtering and shutdown contract.
...
Select any of the [52 case-sensitive ACE names](../crates/audio2face3d/src/inference/animation.rs) with
