...
pub type Result<T, E = Audio2xError> = std::result::Result<T, E>;

#[derive(Debug, Error, Clone, PartialEq, Eq)]
pub enum Audio2xError {
...
pub fn checked_i32(value: usize, field: &'static str) -> Result<i32> {
    i32::try_from(value).map_err(|_| Audio2xError::IntegerOverflow {
        field,
        value,
        target: "i32",
    })
...
pub fn checked_u32(value: usize, field: &'static str) -> Result<u32> {
    u32::try_from(value).map_err(|_| Audio2xError::IntegerOverflow {
        field,
        value,
        target: "u32",
    })
