...
use audio2x_core::{Dimension, ElementType, IoMode, Shape};
...
fn cpp_fixture_matches_rust_tensor_rt_engine() {
    let engine = env::var_os("AUDIO2X_REFERENCE_ENGINE")
        .expect("AUDIO2X_REFERENCE_ENGINE must name the generated TensorRT engine");
    let fixture = env::var_os("AUDIO2X_REFERENCE_TENSORS")
        .expect("AUDIO2X_REFERENCE_TENSORS must name the matching C++ tensor fixture");
