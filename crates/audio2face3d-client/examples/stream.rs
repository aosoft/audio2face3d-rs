...
fn main() -> std::result::Result<(), Box<dyn std::error::Error>> {
    ...
    let client = match mode.as_str() {
        #[cfg(feature = "runtime")]
        "direct" => wait(Client::direct(audio2face3d_client::DirectConfig {
            engine: audio2face3d_client::InferenceConfig {
                backend: audio2face3d_client::BackendKind::Regression,
        ...
        "server" => {
            ...
            runtime = tokio::runtime::Builder::new_multi_thread()
                ...
                .build()?;
            let mut config =
                audio2face3d_client::ServerConfig::new(args.get(2).ok_or("URL required")?);
