...
extern "C" __global__ void audio2x_skin_postprocess(
...
extern "C" __global__ void audio2x_mark_initialized(
    unsigned long long* initialized_tracks,
    const unsigned long long* active_tracks,
    size_t word_count) {
...
extern "C" __global__ void audio2x_tongue_postprocess(
    float* results, size_t results_offset, size_t results_stride,
    const float* input_deltas, size_t input_offset, size_t input_stride,
...
extern "C" __global__ void audio2x_eyes_postprocess(
